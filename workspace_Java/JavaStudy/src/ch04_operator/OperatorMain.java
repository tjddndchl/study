...
public class OperatorMain {
	...
	public static void main(String[] args) {
		...
		//inputId 가 7 이상이면 통과, 아니면 재입력 출력
		...
		int userNum = Integer.parseInt(age);
		...
		System.out.printf("입력아이디:%s, 문자열의길이:%d \n", inputId2,len);
		String output2 = (len >= 8 && len <15)?
				"사용 가능한 아이디 입니다.": "8~14자리로 입력하세요.";
