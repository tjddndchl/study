...
import ch09_class.commons.UtiliClass;

public class StudentMain {

	public static void main(String[] args) {
		//student 클래스를 인스턴트화(객체화) 함.
		...
		//캡슐화적용
		//같은 private 필드는 해당클래스의 메서드를 사용해서 접큰
		...
		Student nick = new Student("닉", 85, 77, 65, UtiliClass.weRound((85 + 77 + 65)/3.0,1));
		...
		stuList.add(nick);
		stuList.add(gildong);
		stuList.add(new Student("주디", 90, 82, 99));
		stuList.add(new Student("짹", 90, 92, 78));
...
//		}
		...
		return 1;//차이가 0보다 크면 b가 더 크기 때문에 순서를 바꿈
		}
	});
		//람다 표현식 java 8부터 사용
