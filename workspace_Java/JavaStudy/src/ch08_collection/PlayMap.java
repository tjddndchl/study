...
public class PlayMap {
	...
	public static void main(String[] args) {
		...
		ArrayList<String> playList = new ArrayList<String>(Arrays.asList(
				...
				"너의 모든 순간 : 성시경",
				"Cream Soda : EXO",
				"on the street (with J. Cole) : J. Cole, j:hope",
				...
				"그중에 그대를 만나 : 김호중",
				"Monologue : 테이",
				"다정히 내 이름을 부르면 : 전건호, 경서",
				"Thirsty : aespa",
				"잘 지내자, 우리 (여름날 우리 X 로이킴) : 로이킴",
				"사랑의 바보 : 제이세라",
				"찬란한 하루 : 멜로망스",
				"KNOCK : 이채연"));
		HashMap<String, ArrayList<String>> singerMap = new HashMap<>();//안써도 상관없음
		...
		//전체 가수들의 리스트를 만들려면
		//1.가수목록생성(유니크하게)
		//2.목록을 순회하여makeSongList 메서드를 사용하여 map에 담기
		...
		//1. 가수리스트 출력(가수 이름 정렬하여)
		//2. 가수 이름 입력받기
		//3. 입력받은 가수만 노래리스트를 출력(Map형태로 담앗)
		System.out.println(singer);
		
		boolean flag = true;
		HashMap<String, ArrayList<String>> inputsinger = new HashMap<String, ArrayList<String>>();
