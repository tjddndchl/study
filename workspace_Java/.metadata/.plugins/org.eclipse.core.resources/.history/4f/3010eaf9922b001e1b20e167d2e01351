...
//		String palgye = "저팔계";
//		//문자열 배열 String []
//		//숫자 4는 첨자를 의미하여, 배열의 크기를 정한다.(배열의 크기는 바뀌지 않음.)
...
//		//기본타입(int,boolean..): 숫자이면 0, boolean이면 flase
...
//		}
//		printArr(subArr);
//		//배열의 복사(shallow copy얇은 복사)주소값 복사
...
//		System.out.println(copy);
		...
		//숫자 배열
		int[] numArr = {23,123,352,462,4325,1,2};
		printArr(numArr);
		...
		printArr(numArr);
		//버블정렬
		//이 알고리즘은 가장 큰값(or 작읍값)을 마치
		//거품 처럼 끝으로 밀어내는 방식으로 동작
		
		//배열의 처음부터 인접한 항목을 쌍으로 비교
		//첫번째 항목이 두번쨰 항목보다 크면 두항목을 교환
		//반복하여 전달 전달
